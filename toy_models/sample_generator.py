...
def simple_reality_sample(nlens=1000, mstar_mu=11.5, mstar_sig=0.1, mhalo_mu=13.0, mhalo_sig=0.3, mstar_mhalo=0.8, \
                          c_sig=0.1, aimf_mu=0., aimf_sig=0.05, logreff_mu=0.46, mstar_err=0.1, radmagrat_err=0.050, \
    ...
    hyperpars = {'h70': h70, 'mstar_mu': mstar_mu, 'mstar_sig': mstar_sig, 'mhalo_mu': mhalo_mu, 'mhalo_sig': mhalo_sig,  \
                 'mstar_mhalo': mstar_mhalo, 'c_sig': c_sig, 'aimf_mu': aimf_mu, 'aimf_sig': aimf_sig, \
                 'logreff_mu': logreff_mu, 'mstar_err': mstar_err, 'radmagrat_err': radmagrat_err, 'imerr': imerr, \
                 'dt_err': dt_err}
