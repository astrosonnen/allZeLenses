...
for i in range(nlens):
    ...
    if not os.path.isfile(chainname):
        ...
        gmb_par = pymc.Normal('gmb', mu=gmb_prior['mu'], tau=1./gmb_prior['sigma']**2, value=2.)
        ...
        gp_group.create_dataset('mu', data=gmb_prior['mu'])
        gp_group.create_dataset('sigma', data=gmb_prior['sigma'])
