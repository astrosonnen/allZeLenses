...
for i in range(nlens):
    print i
    chainname = chaindir+'%s_lens_%02d_psifit_brokenalpha_H0%d.hdf5'%(mockname, i, H0)
    if not os.path.isfile(chainname):
        ...
        timedelay_logp = pymc.Normal('timedelay', mu=timedelay*70./H0, tau=1./lens.obs_timedelay[1]**2, value=lens.obs_timedelay[0], observed=True)
