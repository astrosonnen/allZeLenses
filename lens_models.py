...
class nfw_deV:
    ...
    def __init__(self,zd=0.3,zs=2.,mstar=1e11,mhalo=1e13,reff_phys=1.,cvir=5.,images=[],source=0.,obs_images=None,obs_lmstar=None,obs_radmagrat=None,obs_timedelay=None,Delta_halo=93.5):
        self.zd = zd
        self.zs = zs
        self.bulge = None
        self.halo = None
...
class nfw_deV_mdme:
    ...
    def __init__(self,zd=0.3,zs=2.,mstar=1e11,mdme=1e11,reff_phys=1.,rs_phys=5.,images=[],source=0.,obs_images=None,obs_lmstar=None,obs_radmagrat=None,obs_timedelay=None, Delta_halo=93.5):
    ...
    def normalize(self):
        #self.rvir = (self.mhalo*cgs.M_Sun*3./self.Delta_halo/(4.*np.pi)/self.rhoc)**(1/3.)/cgs.kpc/self.arcsec2kpc
        self.rs = self.rs_phys/self.arcsec2kpc
        self.halo = self.mdme/NFW_profile.M2d(self.reff, self.rs)/self.S_cr
        self.bulge = self.mstar/self.S_cr
...
class sps_deV:
    ...
    def __init__(self,zd=0.3,zs=2.,mstar=1e11,mdme=1e11,reff_phys=1.,gammadm=2.,images=[],source=0.,obs_images=None,obs_lmstar=None,obs_radmagrat=None,obs_timedelay=None, Delta_halo=93.5):
